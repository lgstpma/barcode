# Etiqueta 9: misma chica 1" x 0.5", sin EXP ni lote (no comestible).
...
$zpl = Build-ZplEtiqueta1 -Codigo "030001" -Descrip "Caja de carton para regalo" -Precio 2.5 -Cant 1 -Expir 0 -ConFecha $false
...
Write-Host "Etiqueta 9 (sin EXP/lote) -> $PrinterName"
